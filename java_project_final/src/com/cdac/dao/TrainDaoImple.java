...
//				Train ex = (Train)session.get(Train.class, train.getTrainId());
//				ex.setItemName(train.getItemName());
//				ex.setPrice(train.getPrice());
//				ex.setPurchaseDate(train.getPurchaseDate()); 
