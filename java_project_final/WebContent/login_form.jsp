...
<body>
 ...
 ">
		...
		<table class="table table-striped " >
			...
			<tbody class="text-light">
				...
				<tr>
					...
					<td><spr:input class="form-control" path="userPass"/>
		...
		<div class="col-4 d-flex justify-content-end align-items-center" >
				<a class="primary" href="prep_forgetpass_form.htm" style="color:red;font-size: medium;font-weight: bold;" >forget password</a>
			</div>
			<div class="col-4 d-flex justify-content-end align-items-center">
